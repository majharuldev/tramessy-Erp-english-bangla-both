...
//       <td style="border:1px solid #ddd;padding:6px">${p.items.map((item, i) => (
//                       <div key={i}>{item.item_name}</div>
//                     ))}</td>
//       <td style="border:1px solid #ddd;padding:6px;text-align:right">${p.items.map((item, i) => (
//                       <div key={i}>{item.quantity}</div>
//                     ))}</td>
//       <td style="border:1px solid #ddd;padding:6px;text-align:right">${p.items.map((item, i) => (
//                       <div key={i}>{item.unit_price}</div>
//                     ))}</td>
//                  <td style="border:1px solid #ddd;padding:6px">${p.service_charge}</td>   
...
//                   <td className="p-2">{p.items.map((item, i) => (
//                       <div key={i}>{item.item_name}</div>
//                     ))}</td>
//                   <td className="p-2">{p.items.map((item, i) => (
//                       <div key={i}>{item.quantity}</div>
