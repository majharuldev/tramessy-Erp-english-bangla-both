...
const AllUsers = () => {
  ...
  return (
    <main className="p-2">
      <Toaster />
      <div className="w-[24rem] md:w-full overflow-hidden overflow-x-auto max-w-7xl mx-auto bg-white/80 backdrop-blur-md shadow-xl rounded-md p-2 py-10 md:p-8 border border-gray-200">
        {/* Header */}
